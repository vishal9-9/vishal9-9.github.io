...
const Projects = ({ data }) => {
    ...
    const { triggerRequest } = useServer();
                            ...
                            <motion.div
                                ...
                                className={`
                                    ...
                                    ${getProjectDetails(data[selectedId].name).type === 'mobile'
                                        ? 'w-full max-w-[380px] h-[800px] max-h-[90vh] rounded-[3rem] border-[8px] border-gray-900 bg-black box-content'
                                        : 'w-full max-w-5xl h-[85vh] rounded-xl border border-white/20 bg-[#0f0f1a]/95 backdrop-blur-3xl'}
                                `}
                            >
                                {/* --- MOBILE FRAME --- */}
                                {getProjectDetails(data[selectedId].name).type === 'mobile' && (
